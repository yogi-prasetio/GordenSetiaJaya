      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        foreach ($user as $val) { ?>
          ...
          <?php if ($val->role == "Admin") { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url('C_resaller') ?>" class="nav-link <?php if ($this->uri->segment(1) == "C_resaller") {
                                                                        echo "active";
                                                                      } ?>">
            ...
            <li class="nav-item">
              <a href="<?= base_url('C_penjualan') ?>" class="nav-link <?php if ($this->uri->segment(1) == "C_penjualan") {
                                                                          echo "active";
                                                                        } ?>">
            ...
            <li class="nav-item">
              <a href="<?= base_url('C_kriteria') ?>" class="nav-link <?php if ($this->uri->segment(1) == "C_kriteria") {
                                                                        echo "active";
                                                                      } ?>">
            ...
            <li class="nav-item">
              <a href="<?= base_url('C_nilai') ?>" class="nav-link <?php if ($this->uri->segment(1) == "C_nilai") {
                                                                      echo "active";
                                                                    } ?>">
